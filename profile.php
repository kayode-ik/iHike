...
<body>
	<div class="row">
		...
		<div class="col-sm-8">
			...
			echo "
			<div>
				<div><img id='cover-img' class='img-rounded' src='assets/cover/$user_cover' alt='cover'>
				</div>
		...
		";
			...
			if (isset($_POST['submit'])) {
				...
				if ($u_cover == '') {
					...
					move_uploaded_file($image_tmp, "assets/cover/$u_cover");
	...
	<div class="row">
		...
		<div class="col-sm-6">
			...
			while ($row_posts = mysqli_fetch_array($run_posts)) {
				...
				// echo  "$upload_image, upload_image";
				...
				if ($content == "No"  && strlen($upload_image) >= 1) {
					...
					$row_user = mysqli_query($con, $get_posts);
					$row = mysqli_fetch_array($run_user);
