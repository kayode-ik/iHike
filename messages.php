                ...
                <div class='load_msg' id='scroll_messages'>
                    <?php
                        ...
                        <div id='loaded_msg'>
                            ...
                            else if($user_from == $user_to_msg AND $user_to == $user_from_msg) {echo " <div class='message' id='green'
                              data-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br> " ;}?></p>
                        </div>
                    ...
                    if(isset($_GET['u_id'])){
                        ...
                        if($u_id == "new") {
                            ...
                            <form action='' method='POST'>
                                ...
                                <input type='submit' name='send_msg' id='btn-msg' class='btn btn-primary' value='send'>
               ...
               <?php
                if(isset($_POST['send_msg'])){
                    ...
                    if($msg == " "){
                        ...
                        echo "<h4 style='color:red;text-align:center;'>Message wis too long! Use only 37 characters!</h4>";
