    ...
    <div class="col-sm-8">
        <form action="" method="POST" enctype="multipart/form-data">
            <table class="table table-bordered table-hover">
                <tr align="center">
                    <td colspan="6" class="active">Edit your profile</td>
                </tr>
                <tr>
                    <td style="font-weight: bold;">Change Your Firstname</td>
                    <td>
                        <input type="text" class="form-control" name="f_name" required value="<?php echo $first_name; ?>">
                    </td>
                </tr>
                <tr>
                    <td style="font-weight: bold;">Change Your Lastname</td>
                    <td>
                        <input type="text" class="form-control" name="l_name" required value="<?php echo $last_name; ?>">
                    </td>
                </tr>
                <tr>
                    <td style="font-weight: bold;">Change Your Username</td>
                    <td>
                        <input type="text" class="form-control" name="u_name" required value="<?php echo $user_name; ?>">
                    </td>
                </tr>
                <tr>
                    <td style="font-weight: bold;">Description</td>
                    <td>
                        <input type="text" class="form-control" name="describe_user" required value="<?php echo $describe_user; ?>">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="email" class="form-control" name="u_email" required value="<?php echo $user_email; ?>">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="font-weight: bold;">Birthdaydate</td>
                    <td>
